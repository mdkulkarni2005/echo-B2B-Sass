...
import { VapiPhoneNumberTab } from "../components/vapi-phone-number-tab";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="overflow-hidden rounded-lg border bg-background">
        <Tabs className="gap-0" defaultValue="phone-numbers" onValueChange={setActiveTab} value={activeTab}>
            <TabsList className="grid h-12 w-full grid-cols-2 p-0">
                <TabsTrigger className="h-full rotate-none" value="phone-numbers">
                    <PhoneIcon />
                    Phone Numbers
                </TabsTrigger>
                <TabsTrigger className="h-full rotate-none" value="assistants">
                    <BotIcon />
                    Ai Assistants
                </TabsTrigger>
            </TabsList>
