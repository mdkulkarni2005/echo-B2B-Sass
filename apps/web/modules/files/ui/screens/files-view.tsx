      ...
      <div className="mx-auto w-full max-w-screen-md">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Upload and manage document for you AI Assistant
          </p>
        </div>
            ...
            <TableBody>
              {(() => {
                ...
                if (files.results.length === 0) {
                  return (
                    <TableRow>
                      <TableCell className="h-24 text-center text-black" colSpan={4}>
                        No files found
                      </TableCell>
                    </TableRow>
                  );
                ...
                return files.results.map((file) => (
                  <TableRow className="hover:bg-muted/50" key={file.id}>
                    ...
                    <TableCell className="px-6 py-4 to-muted-foreground">
                      {file.size}
                    </TableCell>
                    <TableCell className="px-6 py-4">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem
                            ...
                            onClick={() => {}}
                          >
                            <TrainIcon className="size-4 mr-2" />
                            Delete
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
